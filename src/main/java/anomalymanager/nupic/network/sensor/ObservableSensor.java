...
import anomalymanager.nupic.network.Layer;
import anomalymanager.nupic.network.Network;
import anomalymanager.nupic.network.Region;

import rx.Observable;

/**
 * Wraps an {@link Observable} or {@link Publisher} event emitter which can be used to input CSV
