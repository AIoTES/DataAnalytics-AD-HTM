...
import anomalymanager.nupic.model.Cell;
import anomalymanager.nupic.model.Segment;
import anomalymanager.nupic.model.Column;
import anomalymanager.nupic.model.ComputeCycle;
import anomalymanager.nupic.model.DistalDendrite;
import anomalymanager.nupic.model.Connections;
import anomalymanager.nupic.model.Persistable;
import anomalymanager.nupic.util.ArrayUtils;
import anomalymanager.nupic.util.BeanUtil;
import anomalymanager.nupic.util.MersenneTwister;
...
public class Parameters implements Persistable {
    ...
    static {
        ...
        defaultTemporalParams.put(KEY.ACTIVATION_THRESHOLD, 20);
        defaultTemporalParams.put(KEY.SEED, 1960);
        
//        defaultTemporalParams.put(KEY.LEARNING_RADIUS, 2048);
        defaultTemporalParams.put(KEY.MIN_THRESHOLD, 13);
        defaultTemporalParams.put(KEY.MAX_NEW_SYNAPSE_COUNT, 31);
        defaultTemporalParams.put(KEY.MAX_SYNAPSES_PER_SEGMENT, 128);
        defaultTemporalParams.put(KEY.MAX_SEGMENTS_PER_CELL, 128);
        defaultTemporalParams.put(KEY.INITIAL_PERMANENCE, 0.24);
        defaultTemporalParams.put(KEY.CONNECTED_PERMANENCE, 0.5);
        defaultTemporalParams.put(KEY.PERMANENCE_INCREMENT, 0.04);
        defaultTemporalParams.put(KEY.PERMANENCE_DECREMENT, 0.008);
        defaultTemporalParams.put(KEY.PREDICTED_SEGMENT_DECREMENT, 0.001);
        ...
        defaultSpatialParams.put(KEY.INPUT_DIMENSIONS, new int[]{0});
        defaultSpatialParams.put(KEY.COLUMN_DIMENSIONS, new int[]{2048});
        defaultSpatialParams.put(KEY.POTENTIAL_RADIUS, 16);
        defaultSpatialParams.put(KEY.POTENTIAL_PCT, 0.8);
        defaultSpatialParams.put(KEY.GLOBAL_INHIBITION, true);
//        defaultSpatialParams.put(KEY.INHIBITION_RADIUS, 0);
//        defaultSpatialParams.put(KEY.LOCAL_AREA_DENSITY, -1.0);
        defaultSpatialParams.put(KEY.NUM_ACTIVE_COLUMNS_PER_INH_AREA, 40.0);
        defaultSpatialParams.put(KEY.SEED, 1956);
//        defaultSpatialParams.put(KEY.STIMULUS_THRESHOLD, 0.0);
        defaultSpatialParams.put(KEY.SYN_PERM_INACTIVE_DEC, 0.0005);
        defaultSpatialParams.put(KEY.SYN_PERM_ACTIVE_INC, 0.003);
        defaultSpatialParams.put(KEY.SYN_PERM_CONNECTED, 0.2);
...
//        defaultSpatialParams.put(KEY.DUTY_CYCLE_PERIOD, 1000);
        defaultSpatialParams.put(KEY.MAX_BOOST, 0.0);
...
//        defaultSpatialParams.put(KEY.LEARN, true);
        ...
        defaultEncoderParams.put(KEY.MAX_VAL, 0.);
        ...
        defaultEncoderParams.put(KEY.ENCODER, "RandomDistributedScalarEncoder");
