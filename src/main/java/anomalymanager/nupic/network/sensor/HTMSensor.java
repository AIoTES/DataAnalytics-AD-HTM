...
import anomalymanager.nupic.algorithms.CLAClassifier;
import anomalymanager.nupic.FieldMetaType;
import anomalymanager.nupic.encoders.AdaptiveScalarEncoder;
import anomalymanager.nupic.encoders.CategoryEncoder;
import anomalymanager.nupic.encoders.CoordinateEncoder;
import anomalymanager.nupic.encoders.DateEncoder;
import anomalymanager.nupic.encoders.DeltaEncoder;
import anomalymanager.nupic.encoders.Encoder;
import anomalymanager.nupic.encoders.EncoderTuple;
import anomalymanager.nupic.encoders.GeospatialCoordinateEncoder;
import anomalymanager.nupic.encoders.LogEncoder;
import anomalymanager.nupic.encoders.MultiEncoder;
import anomalymanager.nupic.encoders.MultiEncoderAssembler;
import anomalymanager.nupic.encoders.RandomDistributedScalarEncoder;
import anomalymanager.nupic.encoders.SDRCategoryEncoder;
import anomalymanager.nupic.encoders.SDRPassThroughEncoder;
import anomalymanager.nupic.encoders.ScalarEncoder;
...
public class HTMSensor<T> implements Sensor<T>, Serializable {
    ...
    private void createEncoder() {
        ...
        if(localParameters != null && 
            (encoderSettings = (Map<String, Map<String, Object>>)localParameters.get(Parameters.KEY.FIELD_ENCODING_MAP)) != null &&
    ...
    public void initEncoder(Parameters p) {
        ...
        Map<String, Map<String, Object>> encoderSettings;
        if((encoderSettings = (Map<String, Map<String, Object>>)p.get(Parameters.KEY.FIELD_ENCODING_MAP)) != null &&
            !encodersInitted) {
